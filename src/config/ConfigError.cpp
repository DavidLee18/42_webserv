...
static const ErrorInfo g_error_infos[] = {
    ...
    ErrorInfo(ERR_DUPLICATE_GLOBAL_CGI_MAPPING,
     ...
     "the same file extension is already assigned to another executable path"),
    ...
    ErrorInfo(ERR_INVALID_CGI_ENV_KEY_VALUE,
     ...
     "the assignment must contain both a non-empty key and a non-empty value"),
    ...
    ErrorInfo(ERR_INVALID_CGI_INLINE_ENV_SYNTAX,
     ...
     "characters after the executable path must start with '(' and follow the exact '(key=value)' format"),
    ...
    ErrorInfo(ERR_INVALID_ERROR_PAGE_MAPPING,
     ...
     "error page mapping",
     "the mapping must contain both a status code and a path in the form status:path and exactly one ':'"),
    ...
    ErrorInfo(ERR_INVALID_HEADER_COLON_COUNT,
     ...
     "a header must contain exactly one ':' separator in the form Header-Name: value"),
    ...
    ErrorInfo(ERR_INVALID_HEADER_VALUE,
     ...
     "HTTP header value",
     "the header value contains non-printable or invalid control characters"),
    ErrorInfo(ERR_INVALID_MAX_BODY_SIZE_VALUE_SYNTAX,
     "Invalid max_body_size value syntax",
     "max_body_size value format",
     "the value after '->{}' must be a numeric string optionally followed by MB, MiB, KB, or KiB"),
    ...
    ErrorInfo(ERR_INVALID_ROUTE_RULE_ADDITIONAL_INFO_SYNTAX,
     ...
     "the line cannot be parsed as valid additional information; allowed keywords are '!', '@', '->{}', and '?'"),
    ...
    ErrorInfo(ERR_MISSING_GLOBAL_CGI_MAPPING_OPERATOR,
     ...
     "the mapping must contain the '->' operator in the form extension -> executable"),
    ErrorInfo(ERR_MISSING_MIME_MAPPING_OPERATOR,
     "Missing MIME type mapping operator",
     "MIME type mapping operator",
     "the mapping must contain the '->' operator in the form extension -> MIME type"),
